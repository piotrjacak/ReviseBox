...
class _SetsPageState extends State<SetsPage> {
  ...
  Widget buildFlashcardList({required BuildContext context, required bool Function(FlashcardSet) filter}) {
      ...
      builder: (context, snapshot) {
        ...
        return ValueListenableBuilder(
          ...
          builder: (context, Box<FlashcardSet> box, _) {
            final sets = box.values.toList().cast<FlashcardSet>().where(filter).toList();
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ModifySetPage(set: sets[index])),
                      );
                    },
                    child: Card(
                      child: Padding(
